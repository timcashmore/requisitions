		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "API Requisitions",
									"targetURL": "#tcrequisitions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tcrequisitions-display": {
								"semanticObject": "tcrequisitions",
								"action": "display",
								"description": "API LIst Requisistions",
								"title": "API Requisitions",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tc.requisitions",
									"url": sap.ui.require.toUrl("tc/requisitions")
								}
							}
						}
					}
